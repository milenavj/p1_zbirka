...
\definecolor{andjelka}{rgb}{0.57, 0.36, 0.51}
\definecolor{jovana}{rgb}{0.87, 0.36, 0.51}
\definecolor{milena}{rgb}{0.0, 0.29, 0.29}
\definecolor{danijela}{rgb}{0.6, 0.0, 0.0}

\newcommand\ssstrana{\ifstampanaverzija \newpage \fi}
\newcommand\sstrana{\ifstampanaverzija \newpage \fi \ifelektronskaverzija \newpage \fi}
\newcommand\estrana{\ifelektronskaverzija \ifresenja \else \newpage \fi \fi} %ako je bez resenja
\newcommand\eestrana{\ifelektronskaverzija \ifresenja \newpage \fi \fi} %ako je sa resenjima
\newcommand\skrati[1]{\ifpdf \else \vspace*{-#1mm} \fi}
\newcommand\eskrati[1]{\ifelektronskaverzija \ifresenja \else \vspace*{-#1mm} \fi \fi}
\newcommand\eeskrati[1]{\ifelektronskaverzija \ifresenja \vspace*{-#1mm} \fi \fi}
...
\newcommand\komentarM[1]{\textcolor{red}{Milena: } \textcolor{milena}{#1}\\}         % komentar
\newcommand\komentarJ[1]{\textcolor{red}{Jovana: } \textcolor{jovana}{#1}\\}         % komentar
\newcommand\komentarD[1]{\textcolor{red}{Danijela: } \textcolor{danijela}{#1}\\}         % komentar
\newcommand\komentarA[1]{\textcolor{red}{Andjelka: } \textcolor{andjelka}{#1}\\}         % komentar
...
\newcommand{\linkresenje}[1]{\ifpdf \skrati{2} \begin{flushright} [Rešenje \refAnswer{#1}] \end{flushright} \fi}
...
\newcommand{\naslovPokretanje}{\textcolor{black}{\textsc{Pokretanje:}}}
\newcommand{\argumenti}[1]{\textcolor{black}{\texttt{\textit{\hspace{2mm}#1}}}}
...
\newcommand{\naslovPokretanje}{\textcolor{dmg}{\textsc{Pokretanje:}}}
\newcommand{\argumenti}[1]{\textcolor{black}{\texttt{\textit{\hspace{2mm}#1}}}}

...
elemenata i ispisati na standardni izlaz. Maksimalna du\v zina niza je
$700$ elemenata. Ne razmatrati da li je u novom nizu element deljiv
svojim indeksom.
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/deljivi_indeksom.c}
\end{Answer}
\fi
...
čine palindrom (zanemariti velika/mala slova). Maksimalna dimenzija
niza je $200$ elemenata.
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/palindrom.c}
\end{Answer}
\fi
...
\end{enumerate}
Napisati i program koji testira rad napisanih funkcija za uneti broj
$m$. Maksimalna dužina niza je $100$ elemenata.
...
deljivi sa $k$. Pretpostaviti da je maksimalna dimenzije niza $100$
elemenata.
...
\begin{Exercise}[label=p.razmena_min_max] 
  ...
  obzir njihova prva pojavljivanja. Maksimalna dužina niza je $100$
  elemenata.
...
%ovaj ne treba resavati, isti ko gore
...
sličica koje se u nizu $a$ pojavljuju više od dva puta. Pretpostaviti
da će uneti niz imati najviše $100$ elemenata.
...
brojeva. Maksimalna dimenzija skupa je $500$ elemenata.
...
niza. Pretpostaviti da će uneti niz imati najviše $100$ elemenata.
...
Pretpostaviti da je maksimalna dimenzija niza $100$ elemenata.
...
\begin{Exercise}[label=p.broj_manjih_od_poslednjeg] 
 ...
 rad funkcije. Pretpostaviti da dužina niza neće biti veća od $100$.
...
\begin{Exercise}[label=p.broj_manjih_od_maksimuma] 
 ...
 testira rad funkcije. Maksimalna dužina niza je $100$ elemenata.
...
\begin{Exercise}[label=p.broj_cifara] 
 ...
 cifara. Maksimalna dužina niza je $100$ elemenata.
...
\begin{Exercise}[label=p.zbir_opsega_niza] 
 ...
 funkcije. Maksimalna dužina niza je $100$ elemenata.
...
\begin{Exercise}[label=p.kvadriranje_parnih] 
 ...
 uneti niz. Maksimalna dužina niza je $100$ elemenata.
...
program koji testira rad funkcije. Maksimalna dužina niza je $200$
elemenata.
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/aritm_sredina_deljivih_sa_tri.c}
\end{Answer}
\fi
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/izbacivanje_ubacivanje_u_niz.c}
\end{Answer}
\fi
...
(broj manji od $100$) i elemente niza i ispisuje da li je uneti niz
permutacija ili ne.
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/permutacija.c}
\end{Answer}
\fi

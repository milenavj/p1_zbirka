...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/brojanje_slova.c}
\end{Answer}
\fi
...
raspoređivanjem elemenata nizova $a$ i $b$, tj.~$c = [a_0, b_0, a_1,
  b_1, \ldots, a_{n-1}, b_{n-1}]$. Pretpostaviti da dimenzija učitanih
nizova nije veća od 100.
...
%TODO ubaciti zadatak sa brisanjem -- ne razumem, sta da se ubaci, ima vec zadatak sa brisanjem? 
\begin{Exercise}[label=vp.zadatak_bez_resenja_12] 
Napisati program koji u nizu dužine $n$ (broj manji od $100$) čiji se
elementi učitavaju sa ulaza eliminiše sve brojeve koji nisu deljivi
svojim indeksom. Niz reorganizovati tako da nema \emph{rupa} koje su
nastale eliminacijom elemenata i ispisati na standardni izlaz.
%U slučaju greške, ispisati odgovarajuću poruku. 
...
%\item Napisati funkciju koja proverava da li elementi niza čine
%  palindrom.
...
negativne elemente niza. Pretpostaviti da je dimenzija niza broj koji
nije veći od $100$.
...
%TODO ovo bi znacilo resenje sabrojem 99, a to nije ono sto zelimo -- ne razumem?
...
Napisati funkciju \kckod{int sadrzi\_bar\_dva(int a[], int na, int
  b[], int nb)} koja proverava da li niz $a$ dužine $na$ sadrži barem
dva broja koja se pojavljuju u nizu $b$ dužine $nb$.  Napisati i
program koji učitava redom dimenzije i elemente nizova $a$ i $b$ i
ispisuje da li uneti nizovi ispunjavaju traženo
svojstvo. Pretpostaviti da će uneti nizovi imati najviše $100$
elemenata.

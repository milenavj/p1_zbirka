...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/autobusi.c}
\end{Answer}
\fi
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/neopadajuce.c}
\end{Answer}
\fi
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/najduzi_neopadajuci.c}
\end{Answer}
\fi
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/uzastopni_jednaki.c}
\end{Answer}
\fi
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/podniz.c}
\end{Answer}
\fi

...
izlaz. Ako nizovi nisu iste dužine ispisati poruku \kckod{Greska!}.
\linkresenje{v2.1_01}
\end{Exercise}
...
ispisivati da se neka cifra pojavila $0$ puta. \uputstvo{Za evidenciju
  broja pojavljivanja svake cifre koristiti niz.}
\linkresenje{v2.1_03}
\end{Exercise}
...
\kckod{EOF} i ispisuje koliko se puta u unetom tekstu pojavila svaka
...
u unetom tekstu pojavili više od $0$ puta. \uputstvo{Za evidenciju
  broja pojavljivanja cifara, malih i velih slova korisiti tri niza.}
\linkresenje{v2.1_04}
\end{Exercise}
...
$100$. U slučaju neispravnog unosa ispisati \kckod{Greska!}.
\linkresenje{v2.1_05}
\end{Exercise}
...
poruku.
\begin{description}
\item{a)} Napisati funkciju \kckod{void ucitaj(int niz[], int dimenzija)} koja učitava sadržaj niza. %ovde sam navela potpise funkcija jer su ove dve funkcije bitne za dalje, ali nije bas uniformno u ostatku zadatka
\item{b)} Napisati funkciju \kckod{void stampaj(int niz[], int dimenzija)} koja štampa sadržaj niza.
...
\kckod{ucitaj} iz zadatka \ref{v2.1_07} učitati elemente niza. Potom
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_01.c}
\end{Answer}
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_02.c}
\end{Answer}
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_03.c}
\end{Answer}
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_04.c}
\end{Answer}
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_05.c}
\end{Answer}
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_06.c}
\end{Answer}

\begin{Exercise}[label=p2.5_07] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_07.c}
\end{Answer}

\begin{Exercise}[label=p2.5_08] 
...
\linkresenje{p2.5_08}
\end{Exercise}
\begin{Answer}[ref=p2.5_08]
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_08.c}
\end{Answer}

\begin{Exercise}[label=p2.5_09] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_09.c}
\end{Answer}

\begin{Exercise}[label=p2.5_10] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi10/5_10.c}
\end{Answer}

\begin{Exercise}[label=p2.5_11] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi11/5_11.c}
\end{Answer}

\begin{Exercise}[label=p2.5_12] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi11/5_12.c}
\end{Answer}

\begin{Exercise}[label=p2.5_13] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi11/5_13.c}
\end{Answer}

\begin{Exercise}[label=p2.5_14] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi11/5_14.c}
\end{Answer}

\begin{Exercise}[label=p2.5_15] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi11/5_15.c}
\end{Answer}

\begin{Exercise}[label=p2.5_16] 
...
\includecode{resenja/2_PredstavljanjePodataka/2.1_Nizovi/praktikumi11/5_16.c}
\end{Answer}

...
Napisati program koji za uneto vreme (broj sati iz intervala $[0,24)$ i broj minuta iz intervala $[0,60)$) ispisuje koliko je sati i minuta ostalo do ponoći. \komentar{TODO Dodati u rešenje
proveru ispravnosti unetog vremena, tj ako neko unese neispravno vreme.}
\linkresenje{v1.2_01}
\end{Exercise}
...
Napisati program koji za uneti ceo broj $x$ ispisuje njegov znak, tj da li je broj jednak nuli,
...
Napisati program koji za uneta tri cela broja ispisuje zbir pozitivnih.  \linkresenje{p1.3_}
\end{Exercise}

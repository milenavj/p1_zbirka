...
\komentar{Ovaj zadatak mozda da ide bez resenja?}
\komentarJ{Link ka resenju zakomentarisan.}
...
U prodavnici je organizovana akcija da svaki kupac dobije najjeftiniji artikal za jedan dinar. Napisati program koji za unete cene tri artikla izračunava ukupnu cenu, kao i koliko dinara se uštedi zahvaljujući popustu. \napomena{Pretpostaviti da su cene artikala pozitivni celi brojevi.}
...
broj minuta u intervalu [0,60)):}\ulaz{18 19}#
...
#\naslovInt#
#\izlaz{Unesite vreme (broj sati u itervalu [0,24),\\
broj minuta u intervalu [0,60)):}\ulaz{23 7}#
#\izlaz{Do ponoci je ostalo 0 sati i 53 minuta.}\end{upotreba}
\end{miditest}
...
#\naslovInt#
#\izlaz{Unesite vreme (broj sati u itervalu [0,24),\\
broj minuta u intervalu [0,60)):}\ulaz{24 20}#
...
#\naslovInt#
#\izlaz{Unesite vreme (broj sati u itervalu [0,24),\\
broj minuta u intervalu [0,60)):}\ulaz{14 0}#
#\izlaz{Do ponoci je ostalo 10 sati i 0 minuta.}\end{upotreba}
\end{miditest}
...
\begin{Exercise}[label=p1.2_05] 
 Napisati program koji učitava pet karaktera i u slučaju da je prvi karakter veliko ili malo slovo $a$  ispisuje unete karaktere obrnutim redosledom, a u suprotnom ništa ne ispisuje. \komentar{Mozda umesto a da bude o, kao skracenica od obrni? Inace, ovaj zadatak je poprilicno besmislen :-)}
 \komentarJ{I meni je takodje besmislen i predlazem da ga obrisemo.}
\begin{miditest}
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Unesite karaktere:}\ulaz{A u E f h}#
...
Program učitava 5 karaktera. Ispisati koliko
puta su se pojavile cifre. Napisati koliko
...
\komentarJ{Uradjeno. Dodata napomena.}
...
\komentarJ{Mislim da je bolje da gornji zadatak ide na vezbe a donji na praktikum.}
\komentarJ{Ovi zadaci su razdvojeni jer je prethodni bio bez else a ovde cemo imati if, else if, else if, else}
...
\komentar{Nisam sigurna da je potrebno ovde traziti da koriste switch, dovoljno je da resenje to koristi...}
\komentarJ{Obrisana napomena.}
...
%\komentarJ{Da li ovaj tekst imamo negde ranije?}
%\komentarJ{Imamo, to je zadatak p1.2_13. Zadatak je zakomentarisan.} 

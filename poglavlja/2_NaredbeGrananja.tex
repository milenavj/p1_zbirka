...
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Unesite tri cela broja:}\ulaz{5 18 -1}#
#\izlaz{Najmanji: -1}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{2}
#\naslovInt#
#\izlaz{Unesite tri cela broja:}\ulaz{0 43 16}#
#\izlaz{Najmanji: 0}#
\end{upotreba}
\end{miditest}
...
\begin{upotreba}{3}
#\naslovInt#
#\izlaz{Unesite tri cela broja:}\ulaz{3 3 3}#
#\izlaz{Najmanji: 3}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{4}
#\naslovInt#
#\izlaz{Unesite tri cela broja:}\ulaz{-5 -5 -5}#
#\izlaz{Najmanji: -5}#
\end{upotreba}
\end{miditest}
...
#\izlaz{Apsolutna vrednost: 52.00}#
\end{upotreba}
\end{miditest}
...
#\izlaz{Greska: nedozvoljeno deljenje nulom.}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{4}
...
zahvaljujući popustu. Cene artikala su celi brojevi. U slučaju neispravnog unosa, ispisati odgovarajuću poruku o grešci.
...
Napisati program koji učitava 3 karaktera od kojih prvi mora biti cifra i 
...
Napisati program koji učitava 3 karaktera i ispisuje proizvod svih karaktera koji su cifre. 
Ukoliko među unetim karakterima nema cifara, program treba da ispise odgovarajuću poruku.
\napomena{Karakteri koji se unose su razmaknuti belinama.}
...
Kasir unosi šifru artikla koja se zadaje kao 3 spojena karaktera koji mogu biti mala slova, velika slova ili cifre. 
U kasi, sve šifre su zapisane malim slovima i ciframa. Napisati program koji unos kasira konvertuje u unos
...
Napisati program koji za dati trocifren broj proverava da li je Armstrongov.
U slučaju neispravnog unosa, ispisati odgovarajuću poruku o grešci.

\begin{miditest}
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Unesite trocifreni broj:}\ulaz{153}#
...
\begin{upotreba}{2}
#\naslovInt#
#\izlaz{Unesite trocifreni broj:}\ulaz{111}#
...
\begin{upotreba}{3}
#\naslovInt#
#\izlaz{Unesite trocifreni broj:}\ulaz{84}#
#\izlaz{Greska: niste uneli trocifreni broj.}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{4}
#\naslovInt#
#\izlaz{Unesite trocifreni broj:}\ulaz{371}#
#\izlaz{Broj je Armstrongov.}#
\end{upotreba}
\end{miditest}
...
\begin{Exercise}[label=KT_NG_15] 
 ...
 U slučaju neispravnog unosa, ispisati odgovarajuću poruku o grešci.
 \napomena{U slučaju da se najmanja ili najveća cifra pojavljuju na više pozicija, uzeti prvo pojavljivanje sa, gledajući sa desna na levo.}
...
\verb|DA| ili \verb|NE|. Koordinate tačaka su realni brojevi jednostruke tačnosti.
...
\begin{Exercise}[label=KT_NG_21] 
 ...
 ceo broj $k$ (1 \geq $k$ \geq 189) ispisuje cifru koja se nalazi na $k$-toj poziciji datog niza.
 U slučaju neispravnog unosa, ispisati odgovarajuću poruku o grešci.
...
vrednost funkcije $F(x, k) = f(f(f(...f(x)))$ gde je funkcija $f$ primenjena $k$-puta i ispisuje je zaokruženu na dve decimale.
U slučaju neispravnog unosa, ispisati odgovarajuću poruku o grešci.
...
#\izlaz{Greska: neispravan unos dana.}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{4}
...
#\izlaz{Greska: neispravan unos meseca.}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{4}
#\naslovInt#
#\izlaz{Unesite godinu:}\ulaz{1998}#
#\izlaz{Unesite mesec:}\ulaz{2}#
#\izlaz{Februar, 28 dana}#
\end{upotreba}
\end{miditest}
...
\begin{upotreba}{3}
#\naslovInt#
#\izlaz{Unesite datum:}\ulaz{1.1.2019.}#
#\izlaz{Prethodni datum: 31.12.2018.}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{4}
#\naslovInt#
#\izlaz{Unesite datum:}\ulaz{10.12.2015.}#
#\izlaz{Prethodni datum: 9.11.2015.}#
\end{upotreba}
\end{miditest}
...
\begin{upotreba}{3}
#\naslovInt#
#\izlaz{Unesite datum:}\ulaz{31.12.2008.}#
#\izlaz{Naredni datum: 1.1.2009.}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{4}
#\naslovInt#
#\izlaz{Unesite datum:}\ulaz{5.5.2005.}#
#\izlaz{Naredni datum: 6.5.2005.}#
\end{upotreba}
\end{miditest}
...
\end{description}
Pretpostaviti da je polje (1,1) crno i da predstavlja donji levi ugao sahovske table. 
%TODO Mozda ubaciti neku sliku/skicu sahovske table? 
U slučaju neispravnog unosa, ispisati odgovarajuću poruku o grešci. 

...
\komentar{TODO Potpisi funkcija ne treba da budu ni verb ni \$ vec u okviru taga kckod, kao sto to pise u uputstvima u okviru kartice za formatiranje teksta}
...
\komentar{Ne postoji glavni i sporedni program, vec samo jedan program, izbaciti rec glavni, ja sam izbacila sa puno mesta, mozda mi je negde promaklo.}
...
Napisati funkciju
\verb|int od_nove_godine(int dan, int mesec, int godina)| koja određuje koliko je dana proteklo od Nove godine do datog datuma. Napisati program koji testira napisanu funkciju. \\ \linkresenje{p1.4_}
\end{Exercise}
\begin{Answer}[ref=p1.4_]
%\includecode{resenja/1_KontrolaToka/1.4_Funkcije/1_14.c}
\end{Answer}

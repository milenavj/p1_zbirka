...
%\includecode{resenja/1_KontrolaToka/1.4_Funkcije/praktikumi8/}
%\end{Answer} 
%\fi
...
\includecode{resenja/1_KontrolaToka/1.4_Funkcije/datum_sledeceg_dana.c}
\end{Answer} 
\fi
...
\includecode{resenja/1_KontrolaToka/1.4_Funkcije/broj_dana_izmedju.c}
\end{Answer} 
\fi

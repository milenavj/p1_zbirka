...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_01.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_02.c}
\end{Answer}
\fi
...
\napomena{Pretpostaviti da je unos ispravan.\footnote{U zadacima sa ovom napomenom treba pretpostaviti da se na ulazu zadaje očekivani broj vrednosti očekivanog tipa u, gde je primereno, odgovarajućem formatu.} }
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_03.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_06.c}
\end{Answer}
\fi


\begin{Exercise}[label=UZ_NI_07] 
Napisati program koji za uneta vremena poletanja i sletanja aviona izražena u satima i minutima ispisuje dužinu trajanja leta. 
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_07.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_08.c}
\end{Answer}
\fi


\begin{Exercise}[label=UZ_NI_09]
Date su dve celobrojne promenljive $a$ i $b$. Napisati program koji promenljivoj $a$ dodeljuje
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_09.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_10.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_11.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_12.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_14.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_15.c}
\sstrana
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_16.c}
\end{Answer}
\fi
...
Napisati program koji učitava težinu avionskog tereta izraženu u funtama, konvertuje je u kilograme i ispisuje zaokruženu na dve decimale. \uputstvo{Jedna funta ima $0,45359237$ kilograma.}
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_20.c}
\sstrana
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_21.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_22.c}
\end{Answer}
\fi
...
\napomena{Pretpostaviti da je unos ispravan.}
\uputstvo{Za računanje površine jednakostraničnog trougla može se iskoristiti obrazac $P = \frac{a^2\cdot \sqrt{3}}{4}$ pri čemu je $a$ dužina stranice. Za računanje korena broja koristiti funkciju \kckod{sqrt} čija se deklaracija nalazi u zaglavlju \kckod{math.h}. }
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_23.c}
\end{Answer}
\fi
...
\napomena{Pretpostaviti da je unos ispravan.}
\uputstvo{Za računanje površine trougla može se koristiti \textit{Heronov} obrazac P = $\sqrt{S\cdot(S-a)\cdot(S-b)\cdot(S-c)}$, pri čemu su $a$, $b$ i $c$ dužine stranica, a $S$ je poluobim.}
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_26.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_27.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_28.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_29.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_30.c}
\end{Answer}
\fi
...
\includecode{resenja/1_OsnovniElementiImperativnogProgramiranja/1.1_Izrazi/izrazi_32.c}
\end{Answer}
\fi

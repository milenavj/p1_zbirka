...
\napomena{Pretpostaviti da je unos ispravan.}
\uputstvo{Za računanje korena broja koristiti funkciju \kckod{sqrt} čija se deklaracija nalazi u zaglavlju \kckod{math.h}. Za računanje površine jednakostraničnog trougla može se iskoristiti obrazac $P = \frac{a^2\cdot \sqrt{3}}{4}$ pri čemu je $a$ dužina stranice.}
...
\napomena{Pretpostaviti da je unos ispravan.}
\uputstvo{Za računanje površine trougla može se koristiti obrazac P = $\sqrt{S\cdot(S-a)\cdot(S-b)\cdot(S-c)}$ pri čemu su $a$, $b$ i $c$ dužine stranica, a $S$ je poluobim.}

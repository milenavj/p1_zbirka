...
\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_01.c}
\end{Answer}
 \fi
...
\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_02.c}
\end{Answer}
 \fi
...
\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_03.c}
\end{Answer}
 \fi
...
%\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_04.c}
...
\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_05.c}
\end{Answer}
\fi
...
\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_06.c}
\end{Answer}
 \fi
...
% Vrednosti na koje pokazuju pokazivači $np$ i $nn$ redom treba da budu broj elemenata niza parnih tj. niza neparnih elemenata. 
 Vrednost na koju pokazuje pokazivač $np$ treba da bude jednaka broju elemenata niza \kckod{parni}, a vrednost na koju pokazuje pokazivač $nn$ treba da bude jednaka broju elemenata niza \kckod{neparni}. 
...
\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_07.c}
\end{Answer}
 \fi
...
\includecode{resenja/2_NapredniTipoviPodataka/2.3_Pokazivaci/pokazivaci_08.c}
\end{Answer}
 \fi

...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_01.c}
\end{Answer}
\fi
...
%\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_08.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/praktikumi11/7.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/praktikumi11/12.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_02.c}
\end{Answer}
\fi
...
%\komentarJ{Ucinila sam ulazne niske smislenim, izlazne ne mogu :)} 
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_03.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/praktikumi11/8.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/praktikumi11/9.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_05.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_06.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/praktikumi11/10.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/praktikumi11/11.c}
\end{Answer}
\fi
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_04.c}
\end{Answer}
\fi
...
\begin{Exercise}[label=p2.3_] 
Napisati funkciju \kckod{int strcspn\_klon(char s[], char t[])}
...
%\komentarJ{Jeste klon strcspn. Ispravljen naziv.}
%\komentarJ{Ispraviti i u resenjima!}
...
%\komentarJ{Dodat je zadatak sa obrtanjem pre ovog zadatka.}
...
\includecode{resenja/3_PredstavljanjePodataka/2.3_Niske/1_07.c}
\end{Answer}
\fi

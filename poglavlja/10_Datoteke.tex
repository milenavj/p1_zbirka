...
\begin{description}
\item{a)} Napisati funkciju \kckod{int unesi\_skup(char s[], FILE* f)}
...
\begin{Exercise}[label=p3_08] 
 ...
 upisuje sve njene rotacije. Maksimalna dužina reči je $20$ karaktera.
U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.
...
U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.
\uputstvo{Reč je palindrom ako se čita isto sa leve i desne strane bez obzira na veličinu slova.}
...
#\naslovDat{dat1.txt}#
#\datoteka{12 sunce kisa oblacno mraz oblacno}#
#\datoteka{mraz oblacno oblacno sveze mecava}#
#\datoteka{mecava mecava}#

#\naslovIzlaz#
#\izlaz{sunce kisa oblacno mraz oblacno mraz}#
#\izlaz{oblacno oblacno sveze mecava mecava mecava}#

#\naslovDat{rez.txt: }#
#\datoteka{sunce kisa oblacno mraz sveze mecava}#
\end{upotreba}
\end{miditest}
\begin{miditest}
\begin{upotreba}{2}

...
\begin{itemize}
\item ukoliko je zadata opcija \kckod{u}, sva mala slova zamenjuje velikim
\item ukoliko je zadata opcija \kckod{l}, sva velika slova zamenjuje malim
\end{itemize}
...
\begin{Exercise}[label=p3_08] 
 ...
 upisuje sve njene rotacije reči. Maksimalna dužina reči je $20$ karaktera.
U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.
...
Maksimalna dužina naziva datoteke je $20$ karaktera, a maksimalna dužina reči u datoteci $50$ karaktera.
U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.

\begin{miditest}
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Unesite ime datoteke:}\ulaz{dat1.txt}#
...
\begin{upotreba}{2}
#\naslovInt#
#\izlaz{Unesite ime datoteke:}\ulaz{dat2.txt}#
...
\begin{upotreba}{3}
#\naslovInt#
#\izlaz{Unesite ime datoteke:}\ulaz{dat3.txt}#
...
\begin{upotreba}{4}
#\naslovInt#
#\izlaz{Unesite ime datoteke:}\ulaz{dat4.txt}#
...
\includecode{resenja/4_Datoteke/sve/12.c}
\end{Answer}
...
Maksimalan broj pravougaonika je $200$, maksimalna dužina imena pravougaonika je $4$.
U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.
...
\begin{Exercise}[label=p3_06] 
 ...
 ispisati sve. Pretpostaviti da broj studenata neće biti veći od $100$.
 U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.
...
#\izlaz{korisnicko ime: mi17234, prosek ocena: 9.6}#
\end{upotreba}
\end{miditest}
\linkresenje{p3_06}
\end{Exercise}
...
specifikatora $\%s$ a potom se za kreiranje niske $ime\_i\_prezime$ u 
traženom formatu može iskoristiti funkcija $strcat$.}
U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.
...
\begin{enumerate}
\item ukoliko je navedena opcija $x$, upisati u izlaznu datoteku recipročni 
razlomak za svaki razlomak iz niza (npr. za $2/3$
treba upisati $3/2$) 
\item ukoliko je navedena opcija $y$, upisati u izlaznu datoteku 
...
Pretpostaviti da su linije maksimalne dužine $80$ karaktera.
U slučaju greške, na standardni izlaz za greške ispisati odgovarajuću poruku.

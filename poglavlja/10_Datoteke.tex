...
Napisati program koji šifrira sadržaj datoteke $plain.txt$ tako što svako slovo ciklično zamenjuje njegovim prethodnikom suprotne veličine i upisuje u datoteku $sifra.txt$. Na primer, \kckod{b} se zamenjuje sa \kckod{A},
...
\includecode{resenja/3_Datoteke/ciklicna_zamena.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/zamena.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/sveubroj.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/naj_cifra.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/zagrade.c}
\end{Answer}

\begin{Exercise}[label=p3_x4]         
Potrebno je napisati program koji prebrojava slova i cifre u datoteci.
\begin{description}
\item{a)} Napisati C funkciju \kckod{int unesiSkup(char *s, FILE* f)}
...
\item{b)} Napisati funkciju
  \kckod{void prebroj(char *s, int *br_slova,int *br_cifara)} kojom se
...
\includecode{resenja/3_Datoteke/rotacija.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/recipodvlaka.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/palindrom.c}
\end{Answer}

\begin{Exercise}[label=p3_iv5]         
U datoteci čije se ime zadaje sa standardnog ulaza nalazi
se broj $n$ ($n\leq 256$), a zatim i $n$ reči dužine najviše $50$ karaktera. Napisati program koji učitava reči iz datoteke u niz i:
  \begin{enumerate}
...
\includecode{resenja/3_Datoteke/ukloni_duplikate.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/zbir_ascii.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/matrica.c}
\end{Answer}
...
\includecode{resenja/3_Datoteke/pravougaonici_kvadrati.c}
\end{Answer}
...
$100$. \uputstvo{Ime i prezime studenta se mogu pročitati pomoću
...
$n$ prirodan broj koji se unosi sa standardnog ulaza. Računaju se i samostalna pojavljivanja reči $r$ i pojavljivanja u okviru neke druge reči. Ispis treba da bude u formatu \kckod{broj_pojavljivanja:linija}.\\
...
reda u datoteci $200$ karaktera. Linije brojati počevši od {\tt 1}. \\
...
\includecode{resenja/3_Datoteke/diff.c}
\end{Answer}

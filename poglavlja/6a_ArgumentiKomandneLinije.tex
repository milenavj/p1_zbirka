...
\includecode{resenja/3_UlazIIzlazIzPrograma/3.1_ArgumentiKomandneLinije/argumenti_01.c}
\end{Answer}
 \fi
...
\includecode{resenja/3_UlazIIzlazIzPrograma/3.1_ArgumentiKomandneLinije/argumenti_02.c}
\end{Answer}
 \fi
...
\includecode{resenja/3_UlazIIzlazIzPrograma/3.1_ArgumentiKomandneLinije/argumenti_03.c}
\sstrana
\end{Answer}
 \fi 
...
\includecode{resenja/3_UlazIIzlazIzPrograma/3.1_ArgumentiKomandneLinije/argumenti_04.c}
\end{Answer}
 \fi
...
\includecode{resenja/3_UlazIIzlazIzPrograma/3.1_ArgumentiKomandneLinije/argumenti_05.c}
\end{Answer}
 \fi
...
\begin{Exercise}[label=p2.6_05] 
 ...
 komandne linije nalaze barem dva ista. \napomena{Uzeti u obzir i naziv programa koji se pokreće.}
...
\includecode{resenja/3_UlazIIzlazIzPrograma/3.1_ArgumentiKomandneLinije/argumenti_06.c}
\end{Answer}
 \fi
...
\includecode{resenja/3_UlazIIzlazIzPrograma/3.1_ArgumentiKomandneLinije/argumenti_07.c}
\end{Answer}
 \fi

...
\times m$:
\begin{enumerate}
  \item Napisati funkciju \kckod{void ucitaj(int mat[][MAX], int* n,
    int* m)} kojom se prvo učitavaju dimezije matrice $m$ i $n$, a
    potom i matrica celih brojeva $mat$. Maksimalna dimenzija matrice
    je $50 \times 50$.
  \item Napisati funkciju \kckod{void ispis(int mat[][MAX], int n, int

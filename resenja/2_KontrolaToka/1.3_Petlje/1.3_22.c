...
int main()
{
  ...
  /* Promenljiva najveca_desetica se postavlja na cifru desetica
     ...
     vrednost broja jer je npr. (-123/10)= -12 i -12 % 10 = -2,
  ...
  /* Ucitava se i preostalih n-1 brojeva i ako se naidje na broj
  ...
  /*II nacin: Inicijalizacija najvece desetice na neku vrednost
   ...
   Zatim se u petlji izracunava rezultat, analogno prvom nacinu.

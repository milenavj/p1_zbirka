...
/* Funkcija koja racuna aritmeticku sredinu oni elemenata niza koji su deljivi sa 3. */
...
int blizu_3(int a[], int n)
{
   ...
   /* Pretpostavka je da je prvi element niza najblizi izracunatoj aritmetickoj sredini. */
	int element = a[0];
	/* Radi brzine izracunavanja pamti se razdaljina izmedju trenutno najblizeg elementa i aritmeticke sredine. 
      Izracunava se apsolutna vrednost razdaljine jer ona moze biti i negativna. Moze se koristiti ugradjena funkcija fabs za racunanje apsolutne vrednosti realnih brojeva.
   */
	...
	for(i=1; i<n; i++)
	{
      ...
      /* Izracunava se razdaljina izmedju tekuceg elementa niza i poredi sa trenutnom razdaljinom. Ako je novodobijena vrednost manja vrsi se zamene zapamcenih parametara. */

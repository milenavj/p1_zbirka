...
int main()
{
  ...
  /* Vrednost x/5000 predstavlja maksimalan broj novcanica od 5000
  ...
  /* Da bi se isti postupak primenio i na ostale novcanice, potrebno
     ...
     racunanje ostatka pri deljenju unete vrednosti x 
     (u primeru 8367) sa 5000. On iznosi 3367. Ovu vrednost 
     dodeljujemo promeljivoj x. */
  x = x % 5000;

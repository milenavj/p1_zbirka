...
int main()
{
  ...
  /* 
     Ucitavamo potrebne vrednosti. Sa unosom podataka tipa
     char moramo biti pazljivi i o tome ce vise biti reci
     u narednim poglavljima kod zadataka za rad sa funkcijama
     getchar i putchar. Zbog toga cemo ovde za ucitavanje
     podataka zatraziti da podatke razdvajamo blanko znakovima
     (a ne znakom za novi red, zarezom ili nekim drugim separatorom).
     Ovaj zahtev navodimo u format stringu funkcije scanf tako sto
     ...
     Ako zelimo da odstampamo znak ", u format stringu
     funkcije printf navodimo \".   
   */
  ...
  /*
     ...
     vrednost bice 48. Da bismo pretvorili ovu numericku vrednost
     u numericku vrednost koja odgovara cifri, od nje oduzimamo
     ASCII kod karakterske konstante '0' koji iznosi upravo 48. 
  */
  c=c-'0';
  ...
  novo_x=levo*(unsigned)pow(10, p+1) +c*(unsigned)pow(10, p) + desno;

/* Navedeni program definise funkciju koja se zove main. Program
   moze da definise vise funkcija, ali obavezno mora da definise
   funkciju koja se zove main i izvrsavanje programa uvek pocinje
   od te funkcije. Pored naziva, zapis svake funkcije cine i
   povratna vrednost funkcije (u ovom slucaju int), lista
   argumenata koje funkcija koristi (u ovom slucaju funkcija nema
   argumenata pa se navode samo prazne zagrade, ()) i telo
   funkcije koje je ograniceno viticastim zagradama ({ i }). O
   ovim pojmovima bice vise reci u narednim poglavljima.

   Unutar tela funkcije navode se naredbe. Unutar navedenog
   programa postoji jedna naredba koja predstavlja poziv funkcije

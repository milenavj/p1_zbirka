/* 
	Napisati funkciju unsigned int apsolutna_vrednost(int x) koja izracunava apsolutnu vrednost broja x. 
	Napisati program koji sa standardnog ulaza ucitava jedan ceo broj i ispisuje rezultat poziva funkcije. 
*/

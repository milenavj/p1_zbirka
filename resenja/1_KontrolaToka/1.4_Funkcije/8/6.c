/*
	Napisati funkciju void grafikon_v(int a, int b, int c, int d) koja vrsi vertikalno prikazivanje zadatih vrednosti.
	Napisati program koji ucitava cetiri pozitivna cela broja i ispisuje rezultat poziva funkcije. 

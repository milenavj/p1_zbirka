/* 
	Napisati funkciju float razlomljeni_deo(float x) koja izracunava razlomljeni deo broja x. 
	Napisati program koji sa standardnog ulaza ucitava jedan realan broj i ispisuje rezultat poziva funkcije.
*/

...
int main()
{
  ...
  { 
     ...
     * tipa unsigned int. Problem nastaje kada je i==0 i pokusa se oduzimanje
     * (i--). Posto su brojevi unsigned, nova vrednost nece biti -1,
     * vec pozitivan ceo broj. Imajuci to na umu, uslov i>=0 ne moze da
     * se stavi u uslov za for petlju. Mnogo sigurnije je brojace 
     * deklarisati da budu tipa int i izbeci ovakvu vrstu problema. */
    if (i == 0)
      break;
  }

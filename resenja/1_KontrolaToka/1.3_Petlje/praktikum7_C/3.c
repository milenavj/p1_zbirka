...
broj sa najvecom vodecom cifrom. Vodeca cifra je prva cifra iz zapisa broja. Ukoliko ima vise takvih, ispisati
prvi. */
...
int main(){
	...
	/* Postavljamo maksimalnu vodecu cifru na 0 - cifre broja su vece ili jednake od 0 pa je ova vrednost neutralna */
	max_vodeca_cifra=0;
	...
	for(i=0; i<n; i++){
		...
		if(vodeca_cifra>max_vodeca_cifra){
			...
			/* Zbog ovoga smo morali i da racunamo vodecu cifru nad kopijom broja x kako ne bismo promenili njegovu vrednost */
			broj=x;
		}
	}

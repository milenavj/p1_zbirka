...
int main()
{
  ...
  /* Promenljiva koja cuva informaciju o tome da li je u nizu postojao element koji je deljiv brojem k. Inicijalna vrednost je 0. */

  indikator = 0;

  /* Ukoliko je element niza deljiv brojem k, indikator se postavlja na 1 i ispisuje se indeks tog elementa. */

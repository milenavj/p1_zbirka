...
int main()
{
  ...
  while((c = getchar()) != EOF)
  {
    /* Ako je procitani karakter veliko slovo uvecava se broj pojavljivanja odgovarajuceg velikog slova. Indeks velikog slova u nizu se odredjuje oduzimanjem slova A. */
    if (c>='A' && c<='Z'){
      velika_slova[c-'A']++;
    }
    else{

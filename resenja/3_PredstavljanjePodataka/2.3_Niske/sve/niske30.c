...
/* Funkcija od niske s formira rezultujucu nisku na sledeci nacin:
   1. Svi karakteri niske s koji su jednaki c1 se dupliraju.
   2. Svi karakteri niske s koji su jednaki c2 se brisu.
   3. Ostali karakteri se samo prepisuju. */
...
int main()
{
  ...
  /* Ucitavaju se niska i karakteri. */

...
/* Funkcija formiraj_broj na osnovu niske b formira ceo broj
   ...
   Ako su cifre broja a, b, c i d, tada broj mozemo kreirati kao:
   a*10^3 + b*10^2 + c*10^1 + d*10^0.
   Medjutim, efikasnije je koristiti Hornerovu semu:
...
int formiraj_broj(char b[])
{
  ...
  /* Prolazak kroz cifre broja i racunanje vrednosti broja
     ...
     dobija kada se od trenutnog karaktera (b[i]) oduzme 
     karakter '0'. 
     Ako se naidje na karakter koji nije cifra, petlja se 

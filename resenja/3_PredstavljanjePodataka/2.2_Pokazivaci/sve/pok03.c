...
/* Funkcija koja racuna presek pravih y = k1 * x + n1 i y = k2 * x 
   + n2. Koordinate preseka (ako postoji) se upisuju na adrese px i 
...
int presek(float k1, float n1, float k2, float n2, float *px,
  ...
  /* Ako je koeficijent pravca jednak, prave su paralelne.
     Povratna vrednost funkcije je 0, kao indikator da nema
     presecne tacke. */
  if (k1 == k2)
    return 0;

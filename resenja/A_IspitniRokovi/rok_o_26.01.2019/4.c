...
int main(int argc, char *argv[]) {
    ...
    /* Proverava da li je opcija ispravno zadata tj. da li pocinje karakterom -. */
    if (argv[1][0] != '-'){
        greska();
    }
    ...
    /* Ucitava se broj pesama. */
    fscanf(ulaz, "%d", &n);

    /* Analizira se zadata opcija. */
    switch(opcija){
        ...
        case 'p':
            ...
            for (i = 0; i < n; i++)
            {
                ...
                /* 4) proverava se da li ime pesme pocinje procitanim karakterom */
        ...
        default:
            /* Ako je zadata pogresna opcija, prekida se izvrsavanje programa. */
            greska();
    }
